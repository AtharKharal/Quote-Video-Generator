...
- `caption`: Contains quote, a text asking for a follow, and a description about the author. It is generated from a function inside the `util.py` file. The description about the author is generated by AI
...
After setup, running the `publisher.py` file will publish to Instagram.
...
- `util.py`: Contain util functions
