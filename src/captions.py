...
His most famous works include The Picture of Dorian Gray and plays like The Importance of Being Earnest. Despite his literary success, his later life was marked by legal troubles, and he spent time in prison. Today, he is remembered as one of the greatest writers in English literature.""",
    ...
    "William Shaksphere": """William Shakespeare was a famous English playwright, poet, and actor. He was born in 1564 and is widely considered one of the greatest writers in the English language. He wrote many plays, including tragedies, comedies, and historical dramas.

Some of his most well-known works include Hamlet, Macbeth, and Romeo and Juliet. His writings are famous for their powerful language, deep characters, and understanding of human nature. Shakespeare’s works are still studied and performed all over the world today.""",

    "Fyodor Dostoevsky": """Fyodor Dostoevsky (1821–1881) was a Russian novelist and one of the greatest writers in world literature. He is known for his deep psychological insight and exploration of themes such as morality, faith, suffering, guilt, and human freedom.
...
He was awarded the Nobel Prize in Literature in 1950 for his writings that champion humanitarian ideals and freedom of thought. Russell’s legacy endures as a voice of reason in a world often ruled by confusion and dogma.""",
    ...
    "George Orwell": """George Orwell (1903–1950) was an English writer and journalist, widely regarded as one of the most influential political thinkers of the 20th century. His work is marked by a deep concern for truth, social justice, and the dangers of oppressive systems.

Orwell is best known for his novels 1984 and Animal Farm. In 1984, he portrays a totalitarian society ruled by constant surveillance, censorship, and manipulation of truth, introducing ideas like “Big Brother” and “thoughtcrime.” Animal Farm uses a simple farm allegory to critique the corruption of revolutionary ideals, especially in relation to the Soviet Union.

Beyond fiction, Orwell’s essays and journalism reflect his commitment to clarity of language and honesty in political thought. He believed that distorted language leads to distorted thinking, a theme he explored in works like “Politics and the English Language.”

His legacy endures as a warning: when power controls truth, reality itself becomes fragile.""",

    "Sir Francis Bacon": """Francis Bacon was an English philosopher, essayist, and statesman of the early 17th century, widely regarded as one of the founders of modern scientific thinking. He was born in 1561 and served in high political positions under Queen Elizabeth I and King James I.

Bacon is best known for developing the idea of empiricism—the belief that knowledge comes primarily from observation and experience rather than tradition or authority. He strongly criticized the old scholastic methods of learning and promoted a new approach based on experimentation and systematic observation, which later became the foundation of the scientific method.

His famous works include Novum Organum and Essays. In his essays, Bacon wrote about practical aspects of life such as truth, studies, ambition, and friendship, offering concise and insightful reflections.

Francis Bacon’s legacy lies in shifting the human mind—from blind acceptance to questioning, from tradition to experiment. He did not just write philosophy; he changed how knowledge itself was pursued.""",

    "Andrea Gibson": """Andrea Gibson is an American spoken word poet, activist, and performer known for their powerful and emotionally charged poetry that explores themes of identity, love, gender, politics, and mental health. Born in 1975, Gibson rose to prominence through the spoken word scene and has been a key figure in modern performance poetry.

Their work often blends personal vulnerability with social critique, addressing issues such as LGBTQ+ identity, inequality, and human connection. Gibson’s performances are especially impactful, using voice, rhythm, and raw emotion to connect deeply with audiences.
